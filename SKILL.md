...
Build interactive UIs that run inside MCP-enabled hosts like Claude Desktop and VS Code/GitHub Copilot. An MCP App combines an MCP tool with an HTML resource to display rich, interactive content.
